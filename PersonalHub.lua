local Ur4n1umLoader2030Snake = "Sn333KE302222nifordelador_cominaodrejklof"
wait(0.2)

if Ur4n1umLoader2030Snake == "Sn333KE302222nifordelador_cominaodrejklof" then
...
local Section = Tab:NewSection("Hubs/Scripts")
...
Section:NewButton("BadMusicPlayer", "", function()
   loadstring(game:HttpGet("https://raw.githubusercontent.com/ImDav1dReal/personalhub/main/musicplayer.lua"))()
end)

  else
    print("Nigger detected... activating anti nigger") 
    while true do
    print("Nigger detected... activating anti nigger") 
    end
end
